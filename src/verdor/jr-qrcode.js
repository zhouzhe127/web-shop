	...
	return function(t) {
		...
		var o = r(2),
			n = function() {
				...
				return e.getQrBase64 = function(e, r) {
					"string" != typeof e && (e = ""), "string" == typeof r ? r = {
						text: r
					} : "object" != typeof r && (r = {}), r = Object.assign({
						padding: 10,
						width: 256,
						height: 256,
						typeNumber: -1,
		...
		r.prototype = {
				...
				for(var t = f.getPatternPosition(this.typeNumber), e = 0; e < t.length; e++)
					for(var r = 0; r < t.length; r++) {
						...
						if(null == this.modules[o][n])
							for(var i = -2; i <= 2; i++)
								for(var a = -2; a <= 2; a++) i == -2 || 2 == i || a == -2 || 2 == a || 0 == i && 0 == a ? this.modules[o + i][n + a] = !0 : this.modules[o + i][n + a] = !1
					}
			},
			...
			for(var C = new Array(p), E = 0, g = 0; g < o; g++)
				for(var u = 0; u < e.length; u++) g < a[u].length && (C[E++] = a[u][g]);
			for(var g = 0; g < i; g++)
				for(var u = 0; u < e.length; u++) g < s[u].length && (C[E++] = s[u][g]);
			return C
		};
		for(var s = {
				MODE_NUMBER: 1,
		...
		n.prototype = {
			...
			multiply: function(t) {
				for(var e = new Array(this.getLength() + t.getLength() - 1), r = 0; r < this.getLength(); r++)
					for(var o = 0; o < t.getLength(); o++) e[r + o] ^= l.gexp(l.glog(this.get(r)) + l.glog(t.get(o)));
				return new n(e, 0)
			},
			mod: function(t) {
			...
			for(var o = r.length / 3, n = new Array, a = 0; a < o; a++)
				for(var s = r[3 * a + 0], u = r[3 * a + 1], h = r[3 * a + 2], f = 0; f < s; f++) n.push(new i(u, h));
			return n
