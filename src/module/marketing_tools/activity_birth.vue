	...
	<section class='birth_act'>
		...
		<div class="content-box">
			...
			<section class="statisticsList" style="display: inline-block;vertical-align: middle;line-height: 40px;font-size: 14px;">
				提前
				<input type="text" name="" placeholder="请输入推送日期" v-model="pushdateNum" style="display: inline-block;width: 200px;height: 36px;text-align: center;line-height: 38px;margin: 0 10px;"
				/>天,发起生日活动推送
			</section>
		</div>
		<!-- 推送时间 -->
		<div class="content-box clearfix">
			...
			<div class="fl" style="height: 40px;display: flex;align-items: center;">
				每日
				<section class="statisticsList" style="display: inline-block;vertical-align: middle;width:200px;height: 40px;margin:0 10px;"
				    @click="showpushList">
