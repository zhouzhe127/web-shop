<template>
	<section class='birth_act'>
		...
		<div class="online-box clearfix">
			...
			<div class="rightHalf">
				<el-button class="fl" type="primary" icon="el-icon-plus" @click="addCoupon('0')" style="width:179px;">选择关联优惠券</el-button>
				<span class="coupon_name" v-if="vouchersCoupon.length > 0">(已关联{{getCouponName(vouchersCoupon)}})</span>
			</div>
		</div>
		<!-- 返券 -->
		<div class="online-box clearfix">
			...
			<div class="rightHalf">
				...
				<span class="coupon_name" v-if="giftCoupon.length > 0">(已关联{{getCouponName(giftCoupon)}})</span>
			</div>
		</div>
		<!-- 消息推送渠道 -->
		<div class="online-box clearfix">
