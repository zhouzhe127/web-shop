<template>
	<section v-if='!showVip' class="custom">
		...
		<div class="online-box clearfix">
			...
			<div class="rightHalf">
				<mulSelect class="fl" :styles="{'border-radius':'4px'}" :list='goodsType' @selOn='selOn' :selects="customSelect" :name='"name"' :keyName='"id"'></mulSelect>
...
/*活动名称的输入框*/
.custom .online-box .rightHalf .coupon_name {
	float: left;
	display: block;
	width: 600px;
	height: 40px;
