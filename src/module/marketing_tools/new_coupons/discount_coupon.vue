...
<template>
	<section>
		<div id="breakCoupon">
			...
			<div class="right">
				<div class="fl">
					<!-- <input class="input reduceamount" placeholder="请输入折扣力度" v-model.trim.number="deratePrice" maxlength="6" />
					<div class="yuan">
						%
					</div> -->
...
export default {
	...
	methods: {
		...
		checkData() {
			...
			//减免金额的验证
			if (this.deratePrice == '' || (this.deratePrice - 0) < 0) {
