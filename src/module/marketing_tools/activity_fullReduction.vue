			...
			<div class="rightHalf">
				<com-table :listHeight='60' :listWidth="1100" :showHand="false" :titleData="titleList" :introData="formList" :widthType='true'>
					...
					<div slot="con-2" slot-scope="props" class="orderCash">
						<section>
							<input type="text" class="cumulative" placeholder="请输入金额" maxlength="6" v-model="props.data.fullCash" onkeyup="value=value.replace(/[^\d]/g,'')" @blur="formatValue(props.data.index,'fullCash')" />
							<span>元</span>
						</section>
					...
					<div slot="con-3" slot-scope="props" class="orderCash">
						<section>
							<input type="text" class="cumulative" placeholder="请输入金额" maxlength="6" v-model="props.data.reduceCsah" onkeyup="value=value.replace(/[^\d]/g,'')" @blur="formatValue(props.data.index,'reduceCsah')" />
							<span>元</span>
						</section>
