		...
		<section v-if="!showDetail">
			<div class="filter clearfix">
				...
				<section class="fl times">
					...
					<el-select v-model="selectShopname" placeholder="请选择" @change="selectShop" style="color:#c0c4cc;width: 179px;">
				...
				<section class="fl times">
					...
					<el-input v-model="phone" placeholder="请输入手机号码" maxlength="11" onkeyup="value=value.replace(/[^\d]/g,'')" style="width:179px;"></el-input>
				</section>
				<!-- 选择门店 -->
				<section class="fl times">
					<span>会员等级</span>
			...
			<div class="filter clearfix" style="position: relative;">
				...
				<section class="fl times">
					...
					<section class="fl">
						...
						<el-input placeholder="请输入年龄" v-model="agestart" maxlength="3" onkeyup="value=value.replace(/[^\d]/g,'')" style="width:179px;">
							<template slot="suffix">岁</template>
						</el-input>
					</section>
					...
					<section class="fl">
						...
						<span class="age">岁</span> -->
						<el-input placeholder="请输入年龄" v-model="agend" maxlength="3" onkeyup="value=value.replace(/[^\d]/g,'')" style="width:179px;">
							<template slot="suffix">岁</template>
						</el-input>
					</section>
				</section>
				...
				<section class="fr times">
					...
					<el-button type="primary" style="width:100px;" @click="searchMember">筛选</el-button>
					...
					<el-button type="warning" style="width:150px;" @click="advanced">高级筛选</el-button>
