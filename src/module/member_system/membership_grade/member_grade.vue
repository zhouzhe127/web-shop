<template>
	<section class="commodity-box" id="grade">
		<section class="commodityAdd fl" @click="addNewlevel('')" v-if="brandId == '0' || brandId == '3'">
			<section class="combox">
				<img src="../../../res/images/comadd.png" alt="添加" />
				<h3>新建会员等级</h3>
			</section>
		</section>
		<section class="fl member-box" v-for="(grade,i) in gradeList" :key="i" @click="addNewlevel(grade)">
