<template>
	<div id="member-import">
        ...
        color: #fff;">实体会员导入</a>
				<input type="file" accept="application/vnd.ms-excel,.csv,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
				    @change="imports" id="file" name="file" style="opacity: 0; position: absolute;top:0;left:0;width: 133px;height: 38px;"
				/>
			</form>
			<a href="javascript:void(0);" @click="filterExport">样例表格下载</a>
		</div>
		<!-- 进度条 -->
		...
		<!-- 列表 -->
		<com-table :listHeight='80' :listName="'实体会员导入'" :showTitle='2' :listWidth="1436" :widthType='true' :introData="formList"
		    :titleData="titleList" :allTotal="allFormList.length">
