		...
		<div id="tan" slot="content" v-cloak>
			<div class="mobilePhone">
				...
				<div class="phoneBox">
					...
					<div class="rightHalf">
						<ul>
							<li v-for="(item,index) in star" :class="item.status ? 'on' : ''" :key="index" @mouseover="selectStars('moveover',index)"
							    @mouseout="selectStars('moveout','')" @click="selectStars('click',index)">
