	...
	<section>
		<section>
			<el-table ref="multipleTable" stripe :header-cell-style = "{'background-color':'#f5f7fa'}" :data="refundFood" border style="width:90%">
				...
				<el-table-column show-overflow-tooltip min-width = "120" align="center" prop="reasonName" label="退菜原因"></el-table-column>
			</el-table>
		</section>
...
export default {
	...
	mounted() {
		let arr = [{name:'添加退菜原因',type: 4,className: 'primary',fn:()=>{
			this.addReason();
		}}];
