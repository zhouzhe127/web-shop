				...
				<div class="online-box clearfix">
					...
					<div class="rightHalf">
						...
						<p class="name">步骤三：二维码规则处填写
							<input type="text" :value="`https://wx.qa.ishandian.com.cn/MiniPro?brandOrAloneId=${userData.currentShop.id}&oid=`" class="url urlo inpurl" readonly="true" /><span style="color: #29A8E0;font-size: 16px;" @click="copyCode">点击复制</span></p>
