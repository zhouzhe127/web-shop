...
export default {
	...
	"InvoigetPurchaseOrderList": { //获取采购单列表
		url: b + "purchaseorder/getPurchaseOrderList",
		method: "get"
	},
	"InvoigetPurchaseOrderStatus": { //获取采购单状态列表
		url: b + "purchaseorder/getPurchaseOrderStatus",
		method: "get"
	},
	"InvoigetPurchaseOrderReviewList": { //获取采购单审核列表
		url: b + "purchaseorder/getPurchaseOrderReviewList",
		method: "get"
	},
	"InvoigetPurchaseOrderReviewStatus": { //获取采购单审核状态列表
		url: b + "purchaseorder/getPurchaseOrderReviewStatus",
		method: "get"
	},
	"InvoigetPurchaseTemplates": { //获取采购单模板列表
		url: b + "template/getPurchaseTemplates",
		method: "get"
	},
	"InvoiDeleteTemplate": { //采购单模板列表删除
	...
	"purchaseorderEdit": { //修改采购单-重新提交
		url: b + "Purchaseorder/edit",
		method: "post"
	},
	"purchaseorderGetDetail": { //获取采购单详情
		url: b + "purchaseorder/getDetail",
		method: "get"
	},
	"templateSavePurchaseTemplate": { //保存采购单模板
		url: b + "template/savePurchaseTemplate",
		method: "post"
	},
	"templateGetPurchaseTemplateContent": { //采购单模板-详情
		url: b + "template/getPurchaseTemplateContent",
		method: "get"
	},
	"editPurchaseOrderStatus": { //采购单-是否审核通过,取消申请
		url: b + "purchaseorder/editPurchaseOrderStatus",
		method: "get"
	},
	"putPurchaseOrderStorage": { //采购单-确认入库
