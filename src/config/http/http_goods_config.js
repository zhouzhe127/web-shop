...
export default {
	...
	'createRetailGood': { //创建商品----零售
		url: r + 'Spu/add',
		method: 'post'
	},
	'getRetailGoodsDetail': { //获取商品详情----零售
		url: r + 'Spu/getOne',
		method: 'get'
	},
	...
	'addRetailCategory': { //添加分类 ————零售
		url: r + 'Category/add',
		method: 'post'
	},
	'editRetailCategory': { //编辑分类 ————零售
		url: r + 'Category/update',
		method: 'post'
	},
	'delRetailCategory': { //删除分类 ————零售
	...
	'GetPackageStatus': { //获取套餐的同步状态
		url: s + 'Synchronous/GetPackageStatus',
		method: 'get'
	},
	'newGetBrandPackage': { //获取品牌的套餐列表，去掉下架的和多余的字段，同步套餐用
		url: s + 'synchronous/getBrandPackage',
		method: 'get'
	},
	'synchronousPackage': { //同步套餐、图片价格--区分部分同步
		url: s + 'synchronous/synchronousPackage',
		method: 'post'
	},
	'SynchronousPackage': { //同步套餐
		url: s + 'Synchronous/SynchronousPackage',
		method: 'get'
	},
	'goodGetBrandPackage': {
	...
	'ChannelGetOne': { //获取某个渠道的信息
		url: s + 'Channel/getOne',
		method: 'post'
	},
	'ChannelRemove': { //删除菜单配置中的套餐或商品
		url: s + 'Channel/remove',
		method: 'post'
	},

	'ChannelEditPerGoods': { //编辑人均商品
	...
	'getAllMarker': { //获取某个标识的等级
		url: s + 'Marker/getAllMarker',
		method: 'get'
	},
	'getGoodsMarker': { //获取标识相关信息
	...
	//新多渠道菜单
	'ChannelGetList': { //获取渠道菜单
		url: s + 'Channel/getList',
		method: 'get'
	},
	'ChannelEditGoods': { //编辑菜单配置
